...
//  hackernewsapi
//
//  Created by Guillaume Garcera on 07/09/11.
...
- (void)getLatest{
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"http://news.ycombinator.com/rss"]];
